...
export class LabelMidfair
{
    constructor()
    {
        ...
        this.placeName = '#Midfair'
        this.placeHead = 'Midfair Town'
        this.placeBody = 'This farming community is the breadbasket of the Moonstone continent. The powerful windmill has become a symbol of Midfair and a point of pride for the community.'
    ...
    setLabelMidfair()
    {
        ...
        this.enterSequence = [
            ...
            ["#pinmidfair", { opacity: 1 }, { duration: .2 }, { at: "-0.2" }],

        ]
        this.leaveSequence = [
            ["#pinmidfair", { opacity: 0 }, { duration: .2 },],
        ...
        //pin
      this.modelname = this.scene.getObjectByName('Well005')
   ...
   /*  setLabelDarkspeare() {
        ...
        this.midfair = this.scene.getObjectByName('Well003')
        this.modelDIV = document.createElement('div')
        this.modelDIV.classList.add('label')
        this.modelDIV.setAttribute('id', 'darkspearelabel')
        ...
        this.captionBox = document.getElementById('caption-box')
        this.pinToolTip = document.createElement('div')
        this.pinToolTip.id = "pin-tooltip-midfair"
