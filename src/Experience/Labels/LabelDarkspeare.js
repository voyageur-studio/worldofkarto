...
export class LabelDarkspeare
{
    constructor()
    {
        ...
        this.placeName = '#Darkspeare'
        this.placeHead = 'Village of Darkspeare'
        this.placeBody = 'A dark magic resides over this small hamlet. Mysteries abound and are sure to peak your interest.'
        this.midfairHead = 'Midfair Town'
        this.midfairBody = 'This farming community is the breadbasket of the Moonstone continent. The powerful windmill has become a symbol of Midfair and a point of pride for the community.'
    ...
    setLabelDarkspeare()
    {
        ...
        this.enterSequence = [
            ...
            ["#pindarkspeare", { opacity: 1 }, { duration: .2 }, { at: "-0.2" }],

        ]
        this.leaveSequence = [
            ["#pindarkspeare", { opacity: 0 }, { duration: .2 },],
        ...
        this.pinToolTip.id = "pindarkspeare"
        ...
        //pin
      this.modelname = this.scene.getObjectByName('Well003')
